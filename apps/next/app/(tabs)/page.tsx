...
import { YStack, H1, H2, H3, Paragraph, Button, Card, XStack, ScrollView, Progress } from '@my/ui'
      ...
      <YStack flex={1} p="$4" pt={80} gap="$4" bg="$background" minHeight="100vh">
          ...
          <Card.Footer padded>
            <YStack gap="$2">
              <Progress value={progressPercent} max={100} size="$3">
                <Progress.Indicator animation="bouncy" bg="green" />
              </Progress>
              {recentUnlock && (
        ...
        <YStack gap="$3">
          ...
          <AnimatedCard elevate size="$4" bordered padding="$4" pressScale={0.98} staggerIndex={4}>
            ...
            <Button size="$4" backgroundColor="blue" width="100%" onPress={handleEveningRoutine}>
